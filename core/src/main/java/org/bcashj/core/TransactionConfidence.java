 ...
 *
 * <p>TransactionConfidence is updated via the {@link org.bcashj.core.TransactionConfidence#incrementDepthInBlocks()}
 * method to ensure the block depth is up to date.</p>
 * To make a copy that won't be changed, use {@link org.bcashj.core.TransactionConfidence#duplicate()}.
 */
public class TransactionConfidence {
     ...
     * and so on. This information is useful for {@link org.bcashj.wallet.CoinSelector} implementations to risk analyze

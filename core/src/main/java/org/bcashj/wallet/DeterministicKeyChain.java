...
import org.bcashj.core.BloomFilter;
import org.bcashj.core.ECKey;
import org.bcashj.core.NetworkParameters;
import org.bcashj.core.Utils;
import org.bcashj.crypto.*;
import org.bcashj.script.Script;
import org.bcashj.utils.Threading;
 ...
 * {@link org.bcashj.crypto.DeterministicHierarchy}, to derive all the keys in the keychain from a master seed.
 ...
 * written down on paper or, when represented using a BIP 39 {@link org.bcashj.crypto.MnemonicCode},
 ...
 * {@link org.bcashj.crypto.DeterministicKey#serializePubB58(org.bcashj.core.NetworkParameters)}. The resulting "xpub..." string encodes
 * sufficient information about the account key to create a watching chain via
 * {@link org.bcashj.crypto.DeterministicKey#deserializeB58(org.bcashj.crypto.DeterministicKey, String, org.bcashj.core.NetworkParameters)}
 * (with null as the first parameter) and then
 * {@link DeterministicKeyChain#DeterministicKeyChain(org.bcashj.crypto.DeterministicKey)}.</p>
 *
 * <p>This class builds on {@link org.bcashj.crypto.DeterministicHierarchy} and
 * {@link org.bcashj.crypto.DeterministicKey} by adding support for serialization to and from protobufs,
...
public class DeterministicKeyChain implements EncryptableKeyChain {
     ...
     *  Using {@link org.bcashj.crypto.KeyCrypter KeyCrypter} to decrypt.
     */
    protected DeterministicKeyChain(DeterministicSeed seed, @Nullable KeyCrypter crypter,
     ...
     * The returned key can be serialized and then passed into {@link #watch(org.bcashj.crypto.DeterministicKey)}
     ...
     * @see org.bcashj.wallet.MarriedKeyChain
     */

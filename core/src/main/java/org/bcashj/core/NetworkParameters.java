...
import org.bcashj.net.discovery.HttpDiscovery;
import org.bcashj.params.*;
import org.bcashj.script.Script;
import org.bcashj.script.ScriptOpCodes;
import org.bcashj.store.BlockStore;
import org.bcashj.store.BlockStoreException;
import org.bcashj.utils.MonetaryFormat;
import org.bcashj.utils.VersionTally;

import static org.bcashj.core.Coin.*;
...
public abstract class NetworkParameters {
    ...
    private static Block createGenesis(NetworkParameters n) {
        ...
        try {
        	//t.clearInputs();
        	//t.clearOutputs();
        	//String pszTimestamp = "We create bcashpay.org on 2018/02/23.";
            ...
            /*
            ByteBuffer b = ByteBuffer.allocate(4+1+pszTimestamp.length());
            b.putInt(486604799).put((byte)4);
            b.put(pszTimestamp.getBytes());
            //TransactionInput input = new TransactionInput(n, t, b.array());
            t.addInput(new TransactionInput(n, t, b.array()));
        ...
        //genesisBlock.setPrevBlockHash(Sha256Hash.wrap("000002320db441472782a6e357c77a614eb1df4828433804073a404cb66d20cb"));
        return genesisBlock;
    }
    ...
    /** Returns discovery objects for seeds implementing the Cartographer protocol. See {@link org.bcashj.net.discovery.HttpDiscovery} for more info. */
    ...
    /**
     * First byte of a base58 encoded address. See {@link org.bcashj.core.Address}. This is the same as acceptableAddressCodes[0] and
    ...
    /** First byte of a base58 encoded dumped private key. See {@link org.bcashj.core.DumpedPrivateKey}. */
    ...
    /**
     * The key used to sign {@link org.bcashj.core.AlertMessage}s. You can use {@link org.bcashj.core.ECKey#verify(byte[], byte[], byte[])} to verify
     * signatures using it.
     */

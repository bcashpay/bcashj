...
import org.bcashj.core.*;
import org.bcashj.core.TransactionConfidence.*;
import org.bcashj.core.listeners.*;
import org.bcashj.crypto.*;
import org.bcashj.script.*;
import org.bcashj.signers.*;
import org.bcashj.utils.*;
import org.bcashj.wallet.Protos.Wallet.*;
import org.bcashj.wallet.WalletTransaction.*;
import org.bcashj.wallet.listeners.KeyChainEventListener;
import org.bcashj.wallet.listeners.ScriptsChangeEventListener;
import org.bcashj.wallet.listeners.WalletChangeEventListener;
import org.bcashj.wallet.listeners.WalletCoinsReceivedEventListener;
import org.bcashj.wallet.listeners.WalletCoinsSentEventListener;
import org.bcashj.wallet.listeners.WalletEventListener;
import org.bcashj.wallet.listeners.WalletReorganizeEventListener;
import org.slf4j.*;
 ...
 * {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, org.bcashj.wallet.WalletFiles.Listener)}
...
public class Wallet extends BaseTaggableObject
     ...
     * {@link org.bcashj.wallet.DeterministicKeyChain#ACCOUNT_ZERO_PATH 0 hardened path}
     */
     ...
     * {@link org.bcashj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS}. The returned key is stable until
    ...
    /**
     * An alias for calling {@link #currentKey(org.bcashj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.bcashj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #currentKey(org.bcashj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #currentAddress(org.bcashj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.bcashj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * {@link org.bcashj.wallet.DeterministicKeyChain}. When the parameter is
     * {@link org.bcashj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} the returned key is suitable for being put
    ...
    /**
     * An alias for calling {@link #freshKey(org.bcashj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.bcashj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #freshKey(org.bcashj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #freshAddress(org.bcashj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.bcashj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * If {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, org.bcashj.wallet.WalletFiles.Listener)}
    ...
    /** See {@link org.bcashj.wallet.DeterministicKeyChain#setLookaheadSize(int)} for more info on this. */
    ...
    /** See {@link org.bcashj.wallet.DeterministicKeyChain#setLookaheadThreshold(int)} for more info on this. */
     ...
     * See {@link org.bcashj.wallet.DeterministicKeyChain#markKeyAsUsed(DeterministicKey)} for more info on this.
     */
     ...
     * @throws org.bcashj.core.ECKey.MissingPrivateKeyException if the seed is unavailable (watching wallet)
     */
    ...
    /**
     * Convenience wrapper around {@link Wallet#encrypt(org.bcashj.crypto.KeyCrypter,
     ...
     * {@link org.bcashj.crypto.KeyCrypterScrypt}.
     *
     ...
     * of {@link org.bcashj.core.ECKey#getCreationTimeSeconds()}. This can return zero if at least one key does
     ...
     * you can use {@link org.bcashj.utils.Threading#waitForUserCode()} to block until the future had a
     ...
     */
    public void setTransactionBroadcaster(@Nullable org.bcashj.core.TransactionBroadcaster broadcaster) {
     ...
     * @throws org.bcashj.wallet.DeterministicUpgradeRequiresPassword if key rotation requires the users password.
     */

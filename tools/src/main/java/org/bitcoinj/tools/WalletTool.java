...
import org.bcashj.core.listeners.BlocksDownloadedEventListener;
import org.bcashj.core.listeners.DownloadProgressTracker;
import org.bcashj.crypto.*;
import org.bcashj.net.discovery.DnsDiscovery;
import org.bcashj.params.MainNetParams;
import org.bcashj.params.RegTestParams;
import org.bcashj.params.TestNet3Params;
import org.bcashj.protocols.payments.PaymentProtocol;
import org.bcashj.protocols.payments.PaymentProtocolException;
import org.bcashj.protocols.payments.PaymentSession;
import org.bcashj.script.ScriptBuilder;
import org.bcashj.store.*;
import org.bcashj.uri.BitcoinURI;
import org.bcashj.uri.BitcoinURIParseException;
import org.bcashj.utils.BriefLogFormatter;
import org.bcashj.wallet.DeterministicSeed;
import org.bcashj.wallet.DeterministicUpgradeRequiredException;
import org.bcashj.wallet.DeterministicUpgradeRequiresPassword;
import org.bcashj.wallet.MarriedKeyChain;
import org.bcashj.wallet.Protos;
import org.bcashj.wallet.SendRequest;
import org.bcashj.wallet.Wallet;
import org.bcashj.wallet.WalletExtension;
import org.bcashj.wallet.WalletProtobufSerializer;
import org.bcashj.wallet.Wallet.BalanceType;
...
import static org.bcashj.core.Coin.parseCoin;
...
public class WalletTool {
    ...
    private static org.bcash.protocols.payments.Protos.PaymentRequest paymentRequest;
    ...
    private static void sendPaymentRequest(String location, boolean verifyPki) {
        if (location.startsWith("http") || location.startsWith(CoinDefinition.coinURIScheme)) {
            ...
            try {
                paymentRequest = org.bcash.protocols.payments.Protos.PaymentRequest.newBuilder().mergeFrom(stream).build();
            } catch(IOException e) {

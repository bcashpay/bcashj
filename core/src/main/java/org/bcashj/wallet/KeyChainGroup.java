...
/**
 * <p>A KeyChainGroup is used by the {@link org.bcashj.wallet.Wallet} and
...
public class KeyChainGroup implements KeyBag {
     ...
     *
     * @throws org.bcashj.crypto.KeyCrypterException Thrown if the wallet encryption fails for some reason,
     ...
     * KeyCrypter to use is {@link org.bcashj.crypto.KeyCrypterScrypt}.
     *
     * @throws org.bcashj.crypto.KeyCrypterException Thrown if the wallet decryption fails for some reason, leaving the group unchanged.
     */

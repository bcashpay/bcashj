...
import org.bcashj.net.StreamConnection;
import org.bcashj.store.BlockStore;
import org.bcashj.store.BlockStoreException;
import org.bcashj.utils.ListenerRegistration;
 ...
 * {@link org.bcashj.net.AbstractTimeoutHandler} and timeout is automatically disabled (using
 * {@link org.bcashj.net.AbstractTimeoutHandler#setTimeoutEnabled(boolean)}) once the version
...
public class Peer extends PeerSocketHandler {
     ...
     * {@link org.bcashj.net.NioClientManager#openConnection(java.net.SocketAddress, StreamConnection)}
     * or
     * {@link org.bcashj.net.NioClient#NioClient(java.net.SocketAddress, StreamConnection, int)}.</p>
     *
    ...
    /**
     * <p>Construct a peer that reads/writes from the given block chain. Transactions stored in a {@link org.bcashj.core.TxConfidenceTable}
...
//            if(!instantSend.mapTxLockVotes.containsKey(item.hash))
     ...
     * Once the pong is received the value returned by {@link org.bcashj.core.Peer#getLastPingTime()} is
     * updated.
    ...
    /**
     * Returns the elapsed time of the last ping/pong cycle. If {@link org.bcashj.core.Peer#ping()} has never
    ...
    /**
     * Returns a moving average of the last N ping/pong cycles. If {@link org.bcashj.core.Peer#ping()} has never
